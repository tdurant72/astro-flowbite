/* empty css                              */
import { c as createComponent, r as renderTemplate, m as maybeRenderHead, a as createAstro, b as addAttribute, d as renderComponent } from './astro/server_ncfLoZ91.mjs';
import 'kleur/colors';
import { $ as $$Layout } from './Layout_VdJ3FdZJ.mjs';
import { $ as $$HeaderSmall } from './HeaderSmall_Ayb_sZl8.mjs';
import { $ as $$Heading } from './Footer_Ba0MAwF7.mjs';
import 'clsx';
...
const $$Alert = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="p-4 mb-4 text-sm text-blue-800 rounded-lg bg-blue-50 dark:bg-slate-900 dark:text-blue-400" role="alert"> <span class="font-medium">${body}</span> </div>`;
}, "/Users/tyusdurant/Documents/local_git/astro-flowbite/src/components/Alert.astro", void 0);

const $$Astro$r = createAstro();
const $$Avatar = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$r, $$props, $$slots);
  Astro2.self = $$Avatar;
  return renderTemplate`${maybeRenderHead()}<div class="relative"> <img class="w-10 h-10 rounded-full" src="./favicon.svg" alt=""> <span class="top-0 left-7 absolute w-3.5 h-3.5 bg-green-400 border-2 border-white dark:border-gray-800 rounded-full"></span> </div>`;
}, "/Users/tyusdurant/Documents/local_git/astro-flowbite/src/components/Avatar.astro", void 0);
...
const $$Badge = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<span class="bg-blue-100 text-blue-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300">${title}</span>`;
}, "/Users/tyusdurant/Documents/local_git/astro-flowbite/src/components/Badge.astro", void 0);

const $$Astro$p = createAstro();
const $$BreadCrumbs = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$p, $$props, $$slots);
  Astro2.self = $$BreadCrumbs;
  const { title, parent, parentLink } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<nav class="flex" aria-label="Breadcrumb"> <ol class="inline-flex items-center space-x-1 md:space-x-3 mb-4"> <li class="inline-flex items-center"> <a href="/" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white"> <svg class="w-3 h-3 mr-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20"> <path d="m19.707 9.293-2-2-7-7a1 1 0 0 0-1.414 0l-7 7-2 2a1 1 0 0 0 1.414 1.414L2 10.414V18a2 2 0 0 0 2 2h3a1 1 0 0 0 1-1v-4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v4a1 1 0 0 0 1 1h3a2 2 0 0 0 2-2v-7.586l.293.293a1 1 0 0 0 1.414-1.414Z"></path> </svg>
Home
</a> </li> <li> <div class="flex items-center"> <svg class="w-3 h-3 text-gray-400 mx-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10"> <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 9 4-4-4-4"></path> </svg> <a${addAttribute(parentLink, "href")} class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">${parent}</a> </div> </li> <li aria-current="page"> <div class="flex items-center"> <svg class="w-3 h-3 text-gray-400 mx-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10"> <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 9 4-4-4-4"></path> </svg> <span class="ml-1 text-sm font-medium text-gray-700 md:ml-2 dark:text-gray-400">${title}</span> </div> </li> </ol> </nav>`;
}, "/Users/tyusdurant/Documents/local_git/astro-flowbite/src/components/BreadCrumbs.astro", void 0);
...
const $$Card = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"> <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"> ${title} </h5> <p class="font-normal text-gray-700 dark:text-gray-400">${body}</p> </div>`;
}, "/Users/tyusdurant/Documents/local_git/astro-flowbite/src/components/Card.astro", void 0);

const $$Astro$n = createAstro();
const $$Jumbotron = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$n, $$props, $$slots);
  Astro2.self = $$Jumbotron;
  const title = "Jumbotron Title";
  const subtitle = "Jumbotron Body";
  const buttonLink1 = "https://google.com";
  const buttonText1 = "Googies";
  const buttonLink2 = "https://msn.com";
  const buttonText2 = "MSN";
  return renderTemplate`${maybeRenderHead()}<section class="bg-white dark:bg-gray-900"> <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16"> <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white"> ${title} </h1> <p class="mb-8 text-lg font-normal text-gray-700 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400"> ${subtitle} </p> <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4"> <!--Needs work --> ${renderComponent($$result, "ButtonGroup", $$ButtonGroup, { "text1": buttonText1, "href1": buttonLink1, "text2": buttonText2, "href2": buttonLink2 })} </div> </div> </section>`;
}, "/Users/tyusdurant/Documents/local_git/astro-flowbite/src/components/Jumbotron.astro", void 0);

const $$Astro$m = createAstro();
const $$Timeline = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$m, $$props, $$slots);
  Astro2.self = $$Timeline;
  const heading = "What I've been up to";
  const dates = ["June 2017", "November 2017", "April 2020"];
  const info = [
    "Web Development and Design Assistant (Anaren Inc.)",
    "Frontend Web Developer (Atmosphere IoT Corp.)",
    "Freelance Web Developer (Shadow Stack LLC)"
  ];
  const details = [
    "I assisted in relaunching the corporate website for the space and defense engineering company. This includes landing pages promoting business markets. The site features pages on business values and career development. The corporate site hosts 700+ products that incorporate documentation, attributes, and more for each product in a data table.",
    "Built and maintained a completely custom software documentation site with Jekyll. Built and maintained a completely custom company website with Wordpress. Built front-end widgets for our IoT software platform with Handlebars and custom css. Maintained social media presence. Marketing tasks using Zoho Campaigns. Custom email templates sent with Zoho and Sendgrid. Project and getting started videos using Adobe Premiere. Analytic and metric tracking using: Klipfolio, Google Analytics, Google Tag Manager, Android Play console, Apple App Store Connect, and a custom Node app to provide usage metrics from our software. Participated in sprint reviews and planning with both Jira and Asana. ",
    "Freelance Web Developer for static and WordPress sites, web applications with React, sales oriented tasks, consulting on the latest and best tools in the industry, and much more."
  ];
  return renderTemplate`${renderComponent($$result, "Heading", $$Heading, { "heading": heading })} ${maybeRenderHead()}<div class="mb-12 px-8"> <ol class="relative border-l border-gray-200 dark:border-gray-700"> ${dates.map((date) => {
    return renderTemplate`<li class="mb-10 ml-4"> <div class="absolute w-3 h-3 bg-primary rounded-full mt-1.5 -left-1.5 border border-white "></div> <time class="mb-1 text-sm font-normal leading-none text-primary dark:text-white"> ${date} </time> <h3 class="text-lg font-semibold text-gray-900 dark:text-white"> ${info[dates.indexOf(date)]} </h3> <p class="mb-4 text-base font-normal text-gray-700 dark:text-gray-400"> ${details[dates.indexOf(date)]} </p> </li>`;
  })} </ol> </div>`;
}, "/Users/tyusdurant/Documents/local_git/astro-flowbite/src/components/Timeline.astro", void 0);

const $$Astro$l = createAstro();
const $$ButtonAlt = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$l, $$props, $$slots);
  Astro2.self = $$ButtonAlt;
  const { text, href, textColor, bgColor } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(href, "href")}${addAttribute(`text-sm font-semibold cursor:pointer leading-6 text-${textColor} dark:text-white border-2 border-${bgColor} font-medium rounded-full text-sm px-5 py-2.5`, "class")}>${text}</a>`;
}, "/Users/tyusdurant/Documents/local_git/astro-flowbite/src/components/ButtonAlt.astro", void 0);

const $$Astro$k = createAstro();
const $$VisualImageHeading = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$k, $$props, $$slots);
  Astro2.self = $$VisualImageHeading;
  const title = "Let's turn your website to a customer magnet";
  const body = "Our simple 8-point plan will increase your customer base in 90 days.";
  const buttonText = "Get Started";
  const buttonLink = "https://www.google.com";
  const buttonTwoText = "Get Started";
  const buttonTwoLink = "https://www.google.com";
  return renderTemplate`${maybeRenderHead()}<section class="bg-stone-100 dark:bg-slate-800"> <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12"> <div class="mr-auto place-self-center lg:col-span-7"> <h1 class="text-primary-700 drop-shadow-[2px_2px_var(--tw-shadow-color)] shadow-gray-800 max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white"> ${title} </h1> <p class="max-w-2xl mb-6 font-light text-gray-700 lg:mb-8 text-lg md:text-xl lg:text-2xl dark:text-gray-400"> ${body} </p> ${renderComponent($$result, "Button", $$Button, { "text": buttonText, "href": buttonLink, "bgColor": "primary", "textColor": "primary-900" })} <span class="mr-4"></span> ${renderComponent($$result, "ButtonAlt", $$ButtonAlt, { "text": buttonTwoText, "href": buttonTwoLink, "bgColor": "primary-700", "textColor": "primary-700" })} </div> <div class="hidden lg:mt-0 lg:col-span-5 lg:flex"> <!-- <img
        src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/hero/phone-mockup.png"
        alt="mockup"
      /> --> ${renderComponent($$result, "Image", $$Image, { "src": siteImage, "width": 211, "height": 425, "alt": "Site Image", "class": "dark:hidden ease-in-out duration-300 hover:rotate-1 hover:scale-105" })} ${renderComponent($$result, "Image", $$Image, { "src": siteImage, "width": 211, "height": 425, "alt": "Site Image", "class": "hidden dark:block ease-in-out duration-300 hover:rotate-1 hover:scale-105" })} </div> </div> </section>`;
}, "/Users/tyusdurant/Documents/local_git/astro-flowbite/src/components/VisualImageHeading.astro", void 0);
...
const $$Team = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const description = "Meet the team behind the scenes at the 2020 Hackathon.";
  const team = [
    {
      name: "Bonnie Green",
      title: "CEO & Web Developer",
      bio: "Bonnie drives the technical strategy of the flowbite platform and brand.",
      github: "https://www.github.com/bonnie",
      image: "https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png"
    },
    {
      name: "Donnie Green",
      title: "CEO & Web Developer",
      bio: "Donnie drives the technical strategy of the flowbite platform and brand.",
      github: "https://www.github.com/bonnie",
      image: "https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png"
    },
    {
      name: "Johhny Green",
      title: "CEO & Web Developer",
      bio: "Johnny drives the technical strategy of the flowbite platform and brand.",
      github: "https://www.github.com/bonnie",
      image: "https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png"
    },
    {
      name: "Connie Green",
      title: "CEO & Web Developer",
      bio: "Connie drives the technical strategy of the flowbite platform and brand.",
      github: "https://www.github.com/bonnie",
      image: "https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png"
    }
  ];
  return renderTemplate`${maybeRenderHead()}<section class="bg-stone-100 dark:bg-slate-800"> <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6"> <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16"> <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white"> ${title} </h2> <p class="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400"> ${description} </p> </div> <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2"> ${team.map((member) => renderTemplate`<div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700"> <img class="w-full rounded-lg sm:rounded-none sm:rounded-l-lg"${addAttribute(member.image, "src")} alt="Bonnie Avatar"> <div class="p-5"> <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white"> <a${addAttribute(member.github, "href")}>${member.name}</a> </h3> <span class="text-gray-500 dark:text-gray-400"> ${member.title} </span> <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400"> ${member.bio} </p> <ul class="flex space-x-4 sm:mt-0"> <li> <a${addAttribute(member.github, "href")} class="text-gray-500 hover:text-gray-900 dark:hover:text-white"> <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"> <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84"></path> </svg> </a> </li> </ul> </div> </div>`)} </div> </div> </section>`;
}, "/Users/tyusdurant/Documents/local_git/astro-flowbite/src/components/Team.astro", void 0);

const $$Astro$i = createAstro();
const $$Pricing = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$i, $$props, $$slots);
  Astro2.self = $$Pricing;
  const title = "Some title for pricing";
  const subtitle = "Some subtitle for pricing";
  const pricing = [
    {
      name: "Starter",
      price: "$29",
...
const $$Blockquote = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<blockquote class="text-xl italic font-semibold text-gray-900 dark:text-white"> <svg class="w-8 h-8 text-gray-400 dark:text-gray-600 mb-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 14"> <path d="M6 0H2a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h4v1a3 3 0 0 1-3 3H2a1 1 0 0 0 0 2h1a5.006 5.006 0 0 0 5-5V2a2 2 0 0 0-2-2Zm10 0h-4a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h4v1a3 3 0 0 1-3 3h-1a1 1 0 0 0 0 2h1a5.006 5.006 0 0 0 5-5V2a2 2 0 0 0-2-2Z"></path> </svg> <p>${text}</p> </blockquote>`;
}, "/Users/tyusdurant/Documents/local_git/astro-flowbite/src/components/Blockquote.astro", void 0);

const $$Astro$e = createAstro();
const $$Tooltip = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$e, $$props, $$slots);
  Astro2.self = $$Tooltip;
  const { button, tooltip } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<button data-tooltip-target="tooltip-animation" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">${button}</button> <div id="tooltip-animation" role="tooltip" class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700"> ${tooltip} <div class="tooltip-arrow" data-popper-arrow></div> </div>`;
}, "/Users/tyusdurant/Documents/local_git/astro-flowbite/src/components/Tooltip.astro", void 0);
...
const $$Tabs = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const tabs = [
    {
      tabTitle: "Profile",
      tabContent: "This is some placeholder content the Profile tab's associated content. Clicking another tab will toggle the visibility of this one for the next. The tab JavaScript swaps classes to control the content visibility and styling."
    },
    {
      tabTitle: "Dashboard",
      tabContent: "This is some placeholder content the Dashboard tab's associated content. Clicking another tab will toggle the visibility of this one for the next. The tab JavaScript swaps classes to control the content visibility and styling."
    },
    {
      tabTitle: "Settings",
      tabContent: "This is some placeholder content the Settings tab's associated content. Clicking another tab will toggle the visibility of this one for the next. The tab JavaScript swaps classes to control the content visibility and styling."
    }
  ];
  return renderTemplate`${maybeRenderHead()}<div class="mb-4 border-b border-gray-200 dark:border-gray-700"> <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="default-tab" data-tabs-toggle="#default-tab-content" role="tablist"> ${tabs.map((tab, index) => renderTemplate`<li class="mr-2" role="presentation"> <button class="inline-block p-4 border-b-2 rounded-t-lg"${addAttribute(`tab-${index}`, "id")}${addAttribute(`#tab-content-${index}`, "data-tabs-target")} type="button" role="tab"${addAttribute(`tab-content-${index}`, "aria-controls")} aria-selected="false"> ${tab.tabTitle} </button> </li>`)} </ul> </div> <div id="default-tab-content"> ${tabs.map((tab, index) => renderTemplate`<div class="hidden p-4 rounded-lg bg-stone-50 dark:bg-slate-900"${addAttribute(`tab-content-${index}`, "id")} role="tabpanel"${addAttribute(`tab-${index}`, "aria-labelledby")}> <p class="text-sm text-gray-500 dark:text-gray-400">${tab.tabContent}</p> </div>`)} </div>`;
}, "/Users/tyusdurant/Documents/local_git/astro-flowbite/src/components/Tabs.astro", void 0);
...
const $$Rating = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="flex items-center space-x-1"> ${Array.from({ length: rating }).map((_) => renderTemplate`<svg class="w-4 h-4 text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20
...
}, "/Users/tyusdurant/Documents/local_git/astro-flowbite/src/components/Rating.astro", void 0);

const $$Astro$b = createAstro();
const $$Modal = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$b, $$props, $$slots);
  Astro2.self = $$Modal;
  const button = "Modal Button Text";
  const title = "Modal Title";
  const content = "Modal Content";
  const accept = "Accept";
  const decline = "Decline";
  return renderTemplate`${maybeRenderHead()}<div class="block space-y-4 md:flex md:space-y-0 md:space-x-4"> <button data-modal-target="medium-modal" data-modal-toggle="medium-modal" class="block w-full md:w-auto text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button"> ${button} </button> </div> <!-- Default Modal --> <div id="medium-modal" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full"> <div class="relative w-full max-w-lg max-h-full"> <!-- Modal content --> <div class="relative bg-white rounded-lg shadow dark:bg-gray-700"> <!-- Modal header --> <div class="flex items-center justify-between p-5 border-b rounded-t dark:border-gray-600"> <h3 class="text-xl font-medium text-gray-900 dark:text-white"> ${title} </h3> <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="medium-modal"> <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14"> <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"></path> </svg> <span class="sr-only">Close modal</span> </button> </div> <!-- Modal body --> <div class="p-6 space-y-6"> <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400"> ${content} </p> </div> <!-- Modal footer --> <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600"> <button data-modal-hide="medium-modal" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">${accept}</button> <button data-modal-hide="medium-modal" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">${decline}</button> </div> </div> </div> </div>`;
}, "/Users/tyusdurant/Documents/local_git/astro-flowbite/src/components/Modal.astro", void 0);

const $$Astro$a = createAstro();
const $$IndicatorCount = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$a, $$props, $$slots);
  Astro2.self = $$IndicatorCount;
  const { button, count, href } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(href, "href")} class="relative inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"> <svg class="w-4 h-4 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 16"> <path d="m10.036 8.278 9.258-7.79A1.979 1.979 0 0 0 18 0H2A1.987 1.987 0 0 0 .641.541l9.395 7.737Z"></path> <path d="M11.241 9.817c-.36.275-.801.425-1.255.427-.428 0-.845-.138-1.187-.395L0 2.6V14a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V2.5l-8.759 7.317Z"></path> </svg> <span class="sr-only">Notifications</span> ${button} ${count > 0 && renderTemplate`<div class="absolute inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white bg-red-500 border-2 border-white rounded-full -top-2 -right-2 dark:border-gray-900"> ${count} </div>`} ${count > 10 && renderTemplate`<div class="absolute inline-flex items-center justify-center w-8 h-6 text-xs font-bold text-white bg-red-500 border-2 border-white rounded-full -top-2 -right-2 dark:border-gray-900"> ${count} </div>`} ${count > 99 && renderTemplate`<div class="absolute inline-flex items-center justify-center w-9 h-6 text-xs font-bold text-white bg-red-500 border-2 border-white rounded-full -top-2 -right-2 dark:border-gray-900">
99+
</div>`} </a>`;
}, "/Users/tyusdurant/Documents/local_git/astro-flowbite/src/components/IndicatorCount.astro", void 0);

const image4 = new Proxy({"src":"/_astro/cta-dashboard-mockup-dark.CfeKXSvB.svg","width":992,"height":715,"format":"svg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/tyusdurant/Documents/local_git/astro-flowbite/src/assets/cta-dashboard-mockup-dark.svg";
							}
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("/Users/tyusdurant/Documents/local_git/astro-flowbite/src/assets/cta-dashboard-mockup-dark.svg");
							return target[name];
						}
					});
...
const $$Banner = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Banner;
  const { text } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<div id="bottom-banner" tabindex="-1" class="fixed bottom-0 start-0 z-50 flex justify-between w-full p-4 border-t border-gray-200 bg-gray-50 dark:bg-gray-700 dark:border-gray-600"> <div class="flex items-center mx-auto"> <p class="flex items-center text-sm font-normal text-gray-500 dark:text-gray-400"> <span class="inline-flex p-1 me-3 bg-gray-200 rounded-full dark:bg-gray-600 w-6 h-6 items-center justify-center"> <svg class="w-3 h-3 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 19"> <path d="M15 1.943v12.114a1 1 0 0 1-1.581.814L8 11V5l5.419-3.871A1 1 0 0 1 15 1.943ZM7 4H2a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2v5a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2V4ZM4 17v-5h1v5H4ZM16 5.183v5.634a2.984 2.984 0 0 0 0-5.634Z"></path> </svg> <span class="sr-only">Discount</span> </span> <span>${text}</span> </p> </div> <div class="flex items-center"> <button data-dismiss-target="#bottom-banner" type="button" class="flex-shrink-0 inline-flex justify-center w-7 h-7 items-center text-gray-400 hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 dark:hover:bg-gray-600 dark:hover:text-white"> <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14"> <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"></path> </svg> <span class="sr-only">Close banner</span> </button> </div> </div>`;
}, "/Users/tyusdurant/Documents/local_git/astro-flowbite/src/components/Banner.astro", void 0);

const $$Astro$7 = createAstro();
const $$Drawer = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$7, $$props, $$slots);
  Astro2.self = $$Drawer;
  const drawerButton = "Click to Open";
  const title = "Drawer Title";
  const body = "Hey here is some content for the drawer. You can put anything you want here.";
  const buttonOneLabel = "Learn More";
  const buttonOneLink = "https://www.google.com";
  const buttonTwoLabel = "Get Access";
  const buttonTwoLink = "https://www.msn.com";
  return renderTemplate`<!-- drawer init and toggle -->${maybeRenderHead()}<div class="text-center"> <button class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" type="button" data-drawer-target="drawer-example" data-drawer-show="drawer-example" aria-controls="drawer-example"> ${drawerButton} </button> </div> <!-- drawer component --> <div id="drawer-example" class="fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white w-80 dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-label"> <h5 id="drawer-label" class="inline-flex items-center mb-4 text-base font-semibold text-gray-500 dark:text-gray-400"><svg class="w-4 h-4 me-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20"> <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM9.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM12 15H8a1 1 0 0 1 0-2h1v-3H8a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1v4h1a1 1 0 0 1 0 2Z"></path> </svg>${title}</h5> <button type="button" data-drawer-hide="drawer-example" aria-controls="drawer-example" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 absolute top-2.5 end-2.5 flex items-center justify-center dark:hover:bg-gray-600 dark:hover:text-white"> <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14"> <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"></path> </svg> <span class="sr-only">Close menu</span> </button> <p class="mb-6 text-sm text-gray-500 dark:text-gray-400">${body}</p> <div class="grid grid-cols-2 gap-4"> <a${addAttribute(buttonOneLink, "href")} class="px-4 py-2 text-sm font-medium text-center text-gray-900 bg-white border border-gray-200 rounded-lg focus:outline-none hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">${buttonOneLabel}</a> <a${addAttribute(buttonTwoLink, "href")} class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">${buttonTwoLabel} <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10"> <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"></path> </svg></a> </div> </div>`;
}, "/Users/tyusdurant/Documents/local_git/astro-flowbite/src/components/Drawer.astro", void 0);

const $$Astro$6 = createAstro();
const $$GalleryMasonry = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$6, $$props, $$slots);
  Astro2.self = $$GalleryMasonry;
  return renderTemplate`${maybeRenderHead()}<div class="grid grid-cols-2 md:grid-cols-4 gap-4"> <div class="grid gap-4"> <div> <img class="h-auto max-w-full rounded-lg" src="https://flowbite.s3.amazonaws.com/docs/gallery/masonry/image.jpg" alt=""> </div> <div> <img class="h-auto max-w-full rounded-lg" src="https://flowbite.s3.amazonaws.com/docs/gallery/masonry/image-1.jpg" alt=""> </div> <div> <img class="h-auto max-w-full rounded-lg" src="https://flowbite.s3.amazonaws.com/docs/gallery/masonry/image-2.jpg" alt=""> </div> </div> <div class="grid gap-4"> <div> <img class="h-auto max-w-full rounded-lg" src="https://flowbite.s3.amazonaws.com/docs/gallery/masonry/image-3.jpg" alt=""> </div> <div> <img class="h-auto max-w-full rounded-lg" src="https://flowbite.s3.amazonaws.com/docs/gallery/masonry/image-4.jpg" alt=""> </div> <div> <img class="h-auto max-w-full rounded-lg" src="https://flowbite.s3.amazonaws.com/docs/gallery/masonry/image-5.jpg" alt=""> </div> </div> <div class="grid gap-4"> <div> <img class="h-auto max-w-full rounded-lg" src="https://flowbite.s3.amazonaws.com/docs/gallery/masonry/image-6.jpg" alt=""> </div> <div> <img class="h-auto max-w-full rounded-lg" src="https://flowbite.s3.amazonaws.com/docs/gallery/masonry/image-7.jpg" alt=""> </div> <div> <img class="h-auto max-w-full rounded-lg" src="https://flowbite.s3.amazonaws.com/docs/gallery/masonry/image-8.jpg" alt=""> </div> </div> <div class="grid gap-4"> <div> <img class="h-auto max-w-full rounded-lg" src="https://flowbite.s3.amazonaws.com/docs/gallery/masonry/image-9.jpg" alt=""> </div> <div> <img class="h-auto max-w-full rounded-lg" src="https://flowbite.s3.amazonaws.com/docs/gallery/masonry/image-10.jpg" alt=""> </div> <div> <img class="h-auto max-w-full rounded-lg" src="https://flowbite.s3.amazonaws.com/docs/gallery/masonry/image-11.jpg" alt=""> </div> </div> </div>`;
}, "/Users/tyusdurant/Documents/local_git/astro-flowbite/src/components/GalleryMasonry.astro", void 0);

const image1 = new Proxy({"src":"/_astro/cta-dashboard-mockup.tTPNfNTr.svg","width":992,"height":715,"format":"svg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/tyusdurant/Documents/local_git/astro-flowbite/src/assets/cta-dashboard-mockup.svg";
							}
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("/Users/tyusdurant/Documents/local_git/astro-flowbite/src/assets/cta-dashboard-mockup.svg");
							return target[name];
						}
					});

const $$Astro$5 = createAstro();
const $$GalleryFeatured = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$5, $$props, $$slots);
  Astro2.self = $$GalleryFeatured;
  return renderTemplate`${maybeRenderHead()}<div class="grid gap-4"> <div> ${renderComponent($$result, "Image", $$Image, { "width": "1536", "height": "834", "src": "https://flowbite.s3.amazonaws.com/docs/gallery/featured/image.jpg", "alt": "...", "class": "h-auto max-w-full rounded-lg" })} </div> <div class="grid grid-cols-4 gap-4"> <div> ${renderComponent($$result, "Image", $$Image, { "src": image1, "alt": "...", "class": "h-auto max-w-full rounded-lg" })} </div> <div> ${renderComponent($$result, "Image", $$Image, { "src": image1, "alt": "...", "class": "h-auto max-w-full rounded-lg" })} </div> <div> ${renderComponent($$result, "Image", $$Image, { "src": image1, "alt": "...", "class": "h-auto max-w-full rounded-lg" })} </div> <div> ${renderComponent($$result, "Image", $$Image, { "src": image1, "alt": "...", "class": "h-auto max-w-full rounded-lg" })} </div> </div> </div>`;
}, "/Users/tyusdurant/Documents/local_git/astro-flowbite/src/components/GalleryFeatured.astro", void 0);

const $$Astro$4 = createAstro();
const $$Kbd = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$4, $$props, $$slots);
  Astro2.self = $$Kbd;
  const { key } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<kbd class="px-2 py-1.5 text-xs font-semibold text-gray-800 bg-gray-100 border border-gray-200 rounded-lg dark:bg-gray-600 dark:text-gray-100 dark:border-gray-500">${key}</kbd>`;
}, "/Users/tyusdurant/Documents/local_git/astro-flowbite/src/components/Kbd.astro", void 0);

const $$Astro$3 = createAstro();
const $$Video = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$3, $$props, $$slots);
  Astro2.self = $$Video;
  const { youtube } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<div class="videowrapper" data-astro-cid-7qzxku2k> <iframe class="border border-gray-200 rounded-lg dark:border-gray-700"${addAttribute(youtube, "src")} title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen data-astro-cid-7qzxku2k></iframe> </div> `;
}, "/Users/tyusdurant/Documents/local_git/astro-flowbite/src/components/Video.astro", void 0);

const $$Astro$2 = createAstro();
const $$VideoAlt = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$2, $$props, $$slots);
  Astro2.self = $$VideoAlt;
  const { youtube } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<div class="videoaltwrapper" data-astro-cid-tfhqeqoo> <div class="menu-bar bg-gray-300 dark:bg-slate-900 h-4 w-full flex relative m-[-10px] left-[20px] pl-[6px] pt-[6px] border-gray-300 dark:border-gray-900 border-[14px]" data-astro-cid-tfhqeqoo> <span class="flex w-3 h-3 me-3 bg-red-500 rounded-full" data-astro-cid-tfhqeqoo></span><span class="flex w-3 h-3 me-3 bg-yellow-400 rounded-full" data-astro-cid-tfhqeqoo></span><span class="flex w-3 h-3 me-3 bg-green-500 rounded-full" data-astro-cid-tfhqeqoo></span> </div> <div class="videowrapper shadow border-gray-300 dark:border-gray-900 bg-gray-300 dark:bg-gray-800 border-[14px] " data-astro-cid-tfhqeqoo> <iframe class="border border-gray-200 rounded-lg dark:border-gray-700"${addAttribute(youtube, "src")} title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen data-astro-cid-tfhqeqoo></iframe> </div> </div> `;
}, "/Users/tyusdurant/Documents/local_git/astro-flowbite/src/components/VideoAlt.astro", void 0);

const thumb4 = new Proxy({"src":"/_astro/githubapi.DoyZopNX.png","width":1280,"height":720,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/tyusdurant/Documents/local_git/astro-flowbite/src/assets/githubapi.png";
							}
							if (target[name] !== undefined) globalThis.astroAsset.referencedImages.add("/Users/tyusdurant/Documents/local_git/astro-flowbite/src/assets/githubapi.png");
							return target[name];
						}
					});

const $$Astro$1 = createAstro();
const $$CustomImageScroll = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$1, $$props, $$slots);
  Astro2.self = $$CustomImageScroll;
  const cards = [
    {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="flex h-screen  items-center justify-center"> <div class="relative w-full  overflow-hidden"> <!-- For some reason the white vignette effect don't work in this sandbox but if you uncomment the following lines in VSCode, they should work --> <div class="dark:hidden"> <div class="pointer-events-none absolute -top-1 z-10 h-20 w-full bg-gradient-to-b from-stone-100 to-transparent"></div> <div class="pointer-events-none absolute -bottom-1 z-10 h-20 w-full bg-gradient-to-t from-stone-100 to-transparent"></div> <div class="pointer-events-none absolute -left-1 z-10 h-full w-20 bg-gradient-to-r from-stone-100 to-transparent"></div> <div class="pointer-events-none absolute -right-1 z-10 h-full w-20 bg-gradient-to-l from-stone-100 to-transparent"></div> </div> <div class="hidden dark:block"> <div class="pointer-events-none absolute -top-1 z-10 h-20 w-full bg-gradient-to-b from-slate-800 to-transparent"></div> <div class="pointer-events-none absolute -bottom-1 z-10 h-20 w-full bg-gradient-to-t from-slate-800 to-transparent"></div> <div class="pointer-events-none absolute -left-1 z-10 h-full w-20 bg-gradient-to-r from-slate-800 to-transparent"></div> <div class="pointer-events-none absolute -right-1 z-10 h-full w-20 bg-gradient-to-l from-slate-800 to-transparent"></div> </div> <div class="mx-auto grid h-[450px] w-[300px] animate-skew-scroll grid-cols-1 gap-5 sm:w-[600px] sm:grid-cols-2"> <!-- These are all the same components - if you're using React, you can use a map to iterate through all of them --> ${cards.map((card) => renderTemplate`<a${addAttribute(card.href, "href")} class="cursor-pointer items-center dark:bg-gray-800 space-x-2 rounded-md border border-gray-100 p-5 shadow-md transition-all hover:-translate-y-1 hover:translate-x-1 hover:scale-[1.025] hover:shadow-xl"> <div class="flex-shrink-0"> ${renderComponent($$result, "Image", $$Image, { "src": card.image, "alt": card.imagealt, "class": "" })} </div> <div class="flex flex-col"> <h3 class="text-gray-600 font-semibold dark:text-white underline">${card.title}</h3> </div> </a>`)} </div> </div> </div>`;
}, "/Users/tyusdurant/Documents/local_git/astro-flowbite/src/components/CustomImageScroll.astro", void 0);
...
const $$Components = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const subtitle = "Component overview. Some properties for this are inline (like heading, button, etc) while others have properties in the component file (table, modal, etc).";
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Components" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div> ${renderComponent($$result2, "HeaderSmall", $$HeaderSmall, { "title": title, "subtitle": subtitle })} </div> <main> <div class="container pb-24"> ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Alert" })} ${renderComponent($$result2, "Alert", $$Alert, { "body": "Hey I'm an alert!" })} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Avatar" })} ${renderComponent($$result2, "Avatar", $$Avatar, {})} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Badge" })} ${renderComponent($$result2, "Badge", $$Badge, { "title": "Badge Title" })} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Breadcrumbs" })} ${renderComponent($$result2, "Breadcrumbs", $$BreadCrumbs, { "title": "Here", "parent": "Something", "parentLink": "/contact" })} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Buttons" })} ${renderComponent($$result2, "Button", $$Button, { "textColor": "primary-900", "bgColor": "white", "text": "Click Me", "href": "https://github.com" })} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Button Group" })} ${renderComponent($$result2, "ButtonGroup", $$ButtonGroup, { "text1": "Google", "href1": "https://google.com", "text2": "Yahoo", "href2": "https://yahoo.com" })} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Card" })} ${renderComponent($$result2, "Card", $$Card, { "title": "Card Title Here", "body": "Some Card Text" })} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Device Mockups" })} ${renderComponent($$result2, "DeviceMockups", $$DeviceMockups, { "lightImage": "https://flowbite.s3.amazonaws.com/blocks/marketing-ui/hero/mockup-1-light.png", "darkImage": "https://flowbite.s3.amazonaws.com/blocks/marketing-ui/hero/mockup-1-dark.png" })} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Form" })} ${renderComponent($$result2, "Form", $$Form, {})} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Gallery" })} ${renderComponent($$result2, "Gallery", $$Gallery, {})} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Gallery (Masonry)" })} ${renderComponent($$result2, "GalleryMasonry", $$GalleryMasonry, {})} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Gallery (Featured)" })} ${renderComponent($$result2, "GalleryFeatured", $$GalleryFeatured, {})} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Jumbotron" })} ${renderComponent($$result2, "Jumbotron", $$Jumbotron, {})} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Table" })} ${renderComponent($$result2, "Table", $$Table, {})} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Timeline" })} ${renderComponent($$result2, "Timeline", $$Timeline, {})} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Visual Image Heading" })} ${renderComponent($$result2, "VisualImageHeading", $$VisualImageHeading, {})} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Teams" })} ${renderComponent($$result2, "Team", $$Team, {})} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Pricing" })} ${renderComponent($$result2, "Pricing", $$Pricing, {})} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "FAQs" })} ${renderComponent($$result2, "FAQ", $$FAQ, {})} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Customer Logos" })} ${renderComponent($$result2, "CustomerLogos", $$CustomerLogos, {})} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Block Quote" })} ${renderComponent($$result2, "Blockquote", $$Blockquote, { "text": "Hey here is some quote from somewhere" })} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Tooltip" })} ${renderComponent($$result2, "Tooltip", $$Tooltip, { "button": "Button Text Here", "tooltip": "Some tooltip text" })} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Tabs" })} ${renderComponent($$result2, "Tabs", $$Tabs, {})} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Rating" })} ${renderComponent($$result2, "Rating", $$Rating, { "rating": 4 })} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Modal" })} ${renderComponent($$result2, "Modal", $$Modal, {})} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Indicator Count" })} ${renderComponent($$result2, "IndicatorCount", $$IndicatorCount, { "button": "Messages", "count": 69, "href": "https://google.com" })} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Carousel" })} ${renderComponent($$result2, "Carousel", $$Carousel, {})} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Banner (see bottom)" })} ${renderComponent($$result2, "Banner", $$Banner, { "text": "Here is some text for the banner" })} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Drawer" })} ${renderComponent($$result2, "Drawer", $$Drawer, {})} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Kbd" })} <p class="mb-8 mt-2 text-lg text-gray-900 dark:text-gray-200">
Press ${renderComponent($$result2, "Kbd", $$Kbd, { "key": "Shift" })} + ${renderComponent($$result2, "Kbd", $$Kbd, { "key": "U" })} in this example.
</p> ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Video" })} <p class="mb-8 mt-2 text-lg text-gray-900 dark:text-gray-200">
Link needs to be the embedded link from youtube.
</p> ${renderComponent($$result2, "Video", $$Video, { "youtube": "https://www.youtube.com/embed/FBFbW2TNRL8?si=eckpNaRHRxQcO8i3" })} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Video Alt" })} <p class="mb-8 mt-2 text-lg text-gray-900 dark:text-gray-200">
Link needs to be the embedded link from youtube.
</p> ${renderComponent($$result2, "VideoAlt", $$VideoAlt, { "youtube": "https://www.youtube.com/embed/8SqtRVx4yuc?si=tMAYAOBGstMZIyds" })} ${renderComponent($$result2, "Heading", $$Heading, { "heading": "Custom Image Scroll" })} ${renderComponent($$result2, "CustomImageScroll", $$CustomImageScroll, {})} </div> </main> ` })}`;
}, "/Users/tyusdurant/Documents/local_git/astro-flowbite/src/pages/components.astro", void 0);

const $$file = "/Users/tyusdurant/Documents/local_git/astro-flowbite/src/pages/components.astro";
